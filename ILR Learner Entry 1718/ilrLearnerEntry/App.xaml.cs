...
namespace ilrLearnerEntry
{
    ...
    {       
        private static readonly string appGuid = "SFA-ilrLearnerEntry-A07151B7-8F1A-4423-ABFB-B85387423E98-1718";
        private static readonly Mutex mutex = new Mutex(false, appGuid);

        private static readonly string appYear = "1718";
        private static readonly string appYearPrevious = "1617";
