...
namespace ILR
{
    public class Learner : ChildEntity, IDataErrorInfo
    {
        ...
        public string CampId { get { return XMLHelper.GetChildValue("CampId", Node, NSMgr); } set { XMLHelper.SetChildValue("CampId", value, Node, NSMgr); OnPropertyChanged("CampId"); GiveFrountEndkickToRefresh(); } }
        ...
        public string ALSCost { get { return XMLHelper.GetChildValue("ALSCost", Node, NSMgr); } set { XMLHelper.SetChildValue("ALSCost", value, Node, NSMgr); OnPropertyChanged("ALSCost"); GiveFrountEndkickToRefresh(); } }
