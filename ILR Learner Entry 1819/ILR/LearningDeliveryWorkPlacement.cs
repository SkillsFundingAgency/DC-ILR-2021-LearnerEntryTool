...
namespace ILR
{
    public class LearningDeliveryWorkPlacement : ChildEntity, IDataErrorInfo
    {
        ...
        public int? WorkPlaceHours { get { string WorkPlaceEmpId = XMLHelper.GetChildValue("WorkPlaceHours", Node, NSMgr); return (WorkPlaceEmpId != null ? int.Parse(WorkPlaceEmpId) : (int?)null); } set { XMLHelper.SetChildValue("WorkPlaceHours", value, Node, NSMgr); OnPropertyChanged("WorkPlaceHours"); } }
